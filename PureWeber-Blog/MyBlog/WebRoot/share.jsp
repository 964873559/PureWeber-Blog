...
<html>
  <div class="about_me" id="mydiv">
    <div class="about_title">
      <span class="glyphicon glyphicon-console" aria-hidden="true"> 您现在的位置：<a href="blog.html">首页</a><strong>></strong><a href="record.html">分享</a></span>
    </div>
